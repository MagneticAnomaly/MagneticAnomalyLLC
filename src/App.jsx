...
function Payloads() {
  ...
  return (
    <>
      ...
      <section id="payloads" ref={container} className="w-full min-h-[100dvh] flex flex-col justify-center pt-8 pb-12 md:py-12 relative z-10">

        {/* Header matching Navbar width */}
        <div className="max-w-7xl w-full px-6 mx-auto mb-6 md:mb-12 lg:mb-20">
        ...
        <div className="max-w-[1400px] w-full px-0 sm:px-4 md:px-8 mx-auto">
          <div className="overflow-visible w-full relative">
            <div className="payloads-track relative w-full h-[550px] md:h-[700px]">

              {/* APP 01 - CoDRAG */}
              <div className="app-panel-1 absolute inset-0 w-full h-full flex flex-col justify-center px-2 sm:px-4 md:px-8">
                <div className="payload-card w-full relative glass-panel rounded-[2.5rem] p-2 md:p-3 overflow-hidden transition-all duration-700 hover:border-titan/50 hover:shadow-[0_0_40px_rgba(229,141,87,0.15)] bg-void/80 backdrop-blur-[7px] min-h-[500px] md:min-h-[650px]">
                  ...
                  <div className="relative z-10 w-full h-full p-4 md:p-14 flex flex-col lg:flex-row gap-4 md:gap-8 lg:gap-12 items-center">
                    ...
                    <div className="w-full lg:w-5/12">
                      ...
                      <p className="font-mono text-[11px] md:text-sm text-telemetry mb-4 md:mb-6 leading-relaxed">
                      ...
                      <div className="space-y-1.5 md:space-y-2 mb-4 md:mb-8 font-mono text-[10px] md:text-xs text-telemetry">
                    ...
                    <div className="w-full lg:w-7/12 h-[300px] md:h-[550px] scale-[0.6] sm:scale-75 md:scale-100 origin-top relative overflow-hidden flex items-center justify-center pb-[1em] md:pb-[4em]">
              ...
              {/* APP 02 - HomeColab */}
              <div className="app-panel-2 absolute inset-0 w-full h-full flex flex-col justify-center px-2 sm:px-4 md:px-8">
                <div className="payload-card w-full relative glass-panel rounded-[2.5rem] p-2 md:p-3 overflow-hidden transition-all duration-700 hover:border-titan/50 hover:shadow-[0_0_40px_rgba(229,141,87,0.15)] bg-void/80 backdrop-blur-[7px] min-h-[500px] md:min-h-[650px]">
                  <div className="relative z-10 w-full h-full p-4 md:p-14 flex flex-col lg:flex-row gap-4 md:gap-8 lg:gap-12 items-center">
                    ...
                    <div className="w-full lg:w-7/12 h-[340px] md:h-[600px] scale-[0.6] sm:scale-75 md:scale-100 origin-top relative flex items-center justify-center gap-6 md:gap-10 pb-[1em] md:pb-[4em]">
                      {/* Phone 1 */}
              ...
              {/* APP 03 - DinnerVision */}
              <div className="app-panel-3 absolute inset-0 w-full h-full flex flex-col justify-center px-2 sm:px-4 md:px-8">
                <div className="payload-card w-full relative glass-panel rounded-[2.5rem] p-2 md:p-3 overflow-hidden transition-all duration-700 hover:border-titan/50 hover:shadow-[0_0_40px_rgba(229,141,87,0.15)] bg-void/80 backdrop-blur-[7px] min-h-[500px] md:min-h-[650px]">
                  <div className="relative z-10 w-full h-full p-4 md:p-14 flex flex-col lg:flex-row gap-4 md:gap-8 lg:gap-12 items-center">
              ...
              {/* APP 04 - DebateHaus */}
              <div className="app-panel-4 absolute inset-0 w-full h-full flex flex-col justify-center px-2 sm:px-4 md:px-8">
                <div className="payload-card w-full relative glass-panel rounded-[2.5rem] p-2 md:p-3 overflow-hidden transition-all duration-700 hover:border-titan/50 hover:shadow-[0_0_40px_rgba(229,141,87,0.15)] bg-void/80 backdrop-blur-[7px] min-h-[500px] md:min-h-[650px]">
                  <div className="relative z-10 w-full h-full p-4 md:p-14 flex flex-col lg:flex-row gap-4 md:gap-8 lg:gap-12 items-center">
      ...
      <section id="manifesto" ref={container} className="w-full min-h-screen relative z-10 flex flex-col items-center justify-center px-6 pointer-events-none">
        <div className="text-center max-w-5xl mx-auto space-y-12">
          ...
          <h2 className="manifesto-drama font-serif text-5xl md:text-7xl lg:text-8xl italic text-titan leading-tight text-shadow-titan">
            Design Problem Solving Is A Puzzle.
          </h2>
        </div>
      </section>
    </>
...
function SystemIndex() {
  ...
  return (
    <div id="gap-to-footer" className="min-h-[100vh] flex flex-col justify-center items-center px-6 relative z-10 w-full">
      <div className="max-w-3xl w-full mt-32 md:mt-64 relative z-20">
        <div className="flex flex-col space-y-3">
          {apps.map((app) => (
            <div key={app.name} className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-6 rounded-2xl border border-white/5 bg-[#030305] transition-colors duration-300 hover:border-white/10 gap-6 sm:gap-4">
...
export default function App() {
  ...
  useGSAP(() => {
    ...
    // Initial State Setup
    gsap.set(".app-panel-2, .app-panel-3, .app-panel-4", { xPercent: 120 });
    ...
    payloadTl.to(".app-panel-1", { xPercent: -120, ease: "power2.inOut", duration: 1.5 }, 2.5);
    payloadTl.to(".app-panel-2", { xPercent: 0, ease: "power2.inOut", duration: 1.5 }, 2.5);
    ...
    payloadTl.to(".app-panel-2", { xPercent: -120, ease: "power2.inOut", duration: 1.5 }, 6.5);
    payloadTl.to(".app-panel-3", { xPercent: 0, ease: "power2.inOut", duration: 1.5 }, 6.5);
    ...
    payloadTl.to(".app-panel-3", { xPercent: -120, ease: "power2.inOut", duration: 1.5 }, 10.5);
    payloadTl.to(".app-panel-4", { xPercent: 0, ease: "power2.inOut", duration: 1.5 }, 10.5);
